...
export default function About(){
    return(
      <div className="min-w-svw min-h-svh">
        ...
        <h1 data-aos="zoom" data-aos-duration="600" className="font-bold md:text-5xl text-3xl mb-3 text-center">About Us</h1>
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 p-10 gap-2">
        <div>
        <h1 data-aos="zoom" data-aos-duration="600" className="font-bold sm:text-lg md:text-2xl bg-clip-text text-transparent bg-gradient-to-r from-blue-900 to-slate-500 text-2xl">
        Why Us
                </h1>
